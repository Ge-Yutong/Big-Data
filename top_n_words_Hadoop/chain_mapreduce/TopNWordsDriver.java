...
public class TopNWordsDriver {
    ...
    public static void main(String[] args) throws Exception {
        ...
        conf.setInt("mapreduce.job.maps", 130);
        ...
        ChainMapper.addMapper(job, TopNWordsMapper.WordFrequencyMapper.class, Object.class, Text.class, Text.class, IntWritable.class, conf);
        job.setCombinerClass(TopNWords.TopNWordsCombiner.class);
        ChainMapper.addMapper(job, TopNWordsMapper.PassThroughMapper.class, Text.class, IntWritable.class, Text.class, IntWritable.class, conf);
        ChainReducer.setReducer(job, TopNWords.TopNWordsReducer.class, Text.class, IntWritable.class, Text.class, IntWritable.class, conf);
